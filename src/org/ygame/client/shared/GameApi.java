...
public final class GameApi {
  ...
  public static class IteratingPlayerContainer implements Container {
    ...
    /**
     * Iterating Container constructor, set game and numberOfPlayers and other info of players<p>
     * game: Game interface with implemented sendVerifyMoveDone, sendUpdateUI
     * playerId: 42, 43
     * playerIds: [42, 43]
     * playersInfo: <PLAYER_ID = 42> <PLAYER_ID = 43>
     * @param game
    ...
    /**
     * After a move is made, update UI:<p>
     * set upadateUi player id as the last player(opponent)
     * @param yourPlayerId
     */
  ...
  public static class GameState {
    ...
    /**
     * get the state that is visible to playerId
     * @param playerId
     * @return
     */
  ...
  public static class UpdateUI extends VerifyMove {
    ...
    /**
     * UpdateUI constructor, called when sending updateUI by game
     * @param yourPlayerId
     * @param playersInfo
     * @param state
     * @param lastState
     ...
     * @param playerIdToNumberOfTokensInPot
     */
    ...
    /**
     * check if the current player is a viewer
     * @return
     */
